...
## [0.1.10] - 2025-11-26 17:42:15

### Fixed
- TypeScript build error: Updated toastRef type from `RefObject<Toast>` to `RefObject<Toast | null>` in DataManagerToolbar and ClassMemberDataTable interfaces
- Build now passes successfully for Netlify deployment

### Why
- Fix TypeScript compilation error that was preventing Netlify deployment
- Align ref types with React's useRef behavior (refs can be null initially)
